...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.date_activated'
        db.add_column(u'submission_submission', 'date_activated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.date_activated'
        db.delete_column(u'submission_submission', 'date_activated')
